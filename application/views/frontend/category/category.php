    ...
    <div class="breadcrumb-area bg-light">
        <div class="container-fluid">
            <div class="breadcrumb-content text-center">
                <h1 class="title"><?= elang("Category") ?> <?= $category->category_name ?></h1>
                <ul>
                    <li>
                    ...
                    <?php foreach ($products as $p) { ?>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 product" data-aos="fade-up" data-aos-delay="400">
                            <div class="product-inner">
                                <div class="thumb">
                                    <a href="<?= base_url('detail-product/' . $p->product_seo) ?>" class="image">
                                        <img class="first-image" src="<?= base_url() ?>assets/images/product/<?= $p->product_photo ?>" width="270" height="350" alt="<?= $p->product_photo ?>" />
                                        <img class="second-image" src="<?= base_url() ?>assets/images/product/<?= $p->product_photo ?>" width="270" height="350" alt="<?= $p->product_photo ?>" />
                                    </a>
                                    <div class="actions">
                                        <a href="wishlist.html" title="Wishlist" class="action wishlist"><i class="pe-7s-like"></i></a>
                                        <a href="#" title="Quickview" class="action quickview" data-bs-toggle="modal" data-bs-target="#product<?= $p->id_product ?>"><i class="pe-7s-search"></i></a>
                                        <a href="compare.html" title="Compare" class="action compare"><i class="pe-7s-shuffle"></i></a>
                                    </div>
                                </div>
                                <div class="content">
                                    <h4 class="sub-title"><a href="single-product.html"><?= $p->category_name ?></a></h4>
                                    <h5 class="title"><a href="single-product.html"><?= $p->product_name ?></a></h5>
                                    <span class="ratings">
                                    ...
                                    <span class="price">
                                        <span class="new">IDR <?= number_format($p->product_price) ?></span>
                                    ...
                                    <div class="shop-list-btn">
                                        ...
                                        <button class="btn btn-sm btn-outline-dark btn-hover-primary" title="Add To Cart"><?= elang("Add To Cart") ?></button>
            ...
            <div class="col-lg-3 col-12 col-custom">
                ...
                <aside class="sidebar_widget mt-10 mt-lg-0">
                    <div class="widget_inner" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <div class="widget-list mb-10">
                            <h3 class="widget-title mb-5"><?= elang('Price Filters') ?></h3>
                            <!-- Widget Menu Start -->
                            <form action="#">
                        ...
                        <div class="widget-list mb-10">
                            <h3 class="widget-title"><?= elang("Categories") ?></h3>
                            <div class="sidebar-body">
                                <ul class="sidebar-list">
                                    <li><a href="#"><?= elang("All Product") ?></a></li>
                                    <?php foreach ($allCategory as $ac) { ?>
                                        <li><a href="<?= base_url('category/' . $ac->id) ?>"><?= $ac->category_name ?></a></li>
                                    <?php } ?>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="widget-list">
                            <h3 class="widget-title mb-4"><?= elang("Recent Products") ?></h3>
                            <div class="sidebar-body product-list-wrapper mb-n6">
                                <?php foreach ($recentProducts as $rp) { ?>
                                    ...
                                    <div class="single-product-list product-hover mb-6">
                                        <div class="thumb">
                                            <a href="<?= base_url('detail-product/' . $p->product_seo) ?>" class="image">
                                                <img class="first-image" src="<?= base_url() ?>/assets/images/product/<?= $rp->product_photo ?>" alt="<?= $rp->product_photo ?>" />
                                                <img class="second-image" src="<?= base_url() ?>/assets/images/product/<?= $rp->product_photo ?>" alt="<?= $rp->product_photo ?>" />
                                            </a>
                                        </div>
                                        <div class="content">
                                            <h5 class="title"><a href="single-product.html"><?= $rp->product_name ?></a></h5>
                                            <span class="price">
                                                <span class="new">IDR <?= number_format($rp->product_price) ?></span>
...
<!-- Modal Start  -->
<?php foreach ($products as $p) { ?>
    <div class="modalquickview modal fade" id="product<?= $p->id_product ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                            ...
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    <a class="swiper-slide" href="#">
                                        <img class="w-100" src="<?= base_url() ?>/assets/images/product/<?= $p->product_photo ?>" alt="<?= $p->product_photo ?>">
                                    </a>
                                </div>
                    ...
                    <div class="col-md-6 col-12 overflow-hidden position-relative">
                        ...
                        <div class="product-summery">
                            ...
                            <div class="price-box mb-2">
                                <span class="regular-price">IDR <?= number_format($p->product_price) ?></span>
                            ...
                            <!-- Description Start -->
                            <p class="desc-content mb-5"><?= $p->product_description ?></p>
                            <!-- Description End -->
                            ...
                            <div class="cart-wishlist-btn pb-4 mb-n3">
                                <div class="add-to_cart mb-3">
                                    <a class="btn btn-outline-dark btn-hover-primary" href="cart.html"><?= elang("Add To Cart") ?></a>
                                </div>
                                <div class="add-to-wishlist mb-3">
                                    <a class="btn btn-outline-dark btn-hover-primary" href="wishlist.html"><?= elang("Add To Wishlist") ?></a>
                                </div>
                            </div>
