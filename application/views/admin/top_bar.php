            ...
            <div class="d-flex">
                <ul class="navbar-nav">
                    <li class="nav-item hidden-on-mobile">
                        <a class="nav-link active" href="<?= base_url('auth/logout') ?>"><?= elang('Sign Out') ?></a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item hidden-on-mobile">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end language-dropdown" aria-labelledby="languageDropDown">
                            <li><a class="dropdown-item id-language" href="" data-id="id"><img src="<?= base_url() ?>/assets/images/flags/germany.png" alt="">Indonesian</a></li>
                            <li><a class="dropdown-item en-language" href="" data-id="en"><img src="<?= base_url() ?>/assets/images/flags/italy.png" alt="">English</a></li>
                        </ul>
                    </li>
                    <li class="nav-item hidden-on-mobile">
